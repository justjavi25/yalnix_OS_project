 ...
 *
 * spring 2024: deleted unused syscalls, and added Shared_Pages
 */
...
// for helper printing---"last known return address," user version
unsigned int lkra; 
...
int Shared_Pages(int a) {
  YSYSCALL(YALNIX_SHARED_PAGES, a, 0, 0, 0);
}
